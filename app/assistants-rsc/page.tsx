...
export default function Home() {
  ...
  return (
    <div className="flex flex-col-reverse">
      <div className="flex flex-row w-full gap-2 p-2 bg-zinc-100">
        <input
          className="w-full p-2 outline-none bg-zinc-100"
          value={input}
        ...
        />
        <button
          className="p-2 rounded-md bg-zinc-900 text-zinc-100"
